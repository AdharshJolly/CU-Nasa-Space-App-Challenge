...
const aboutItems = [
  {
    ...
    title: "Venue",
    description: "Global Virtual & Local Events Worldwide",
  },
  {
  ...
  },
  {
    ...
    title: "Participants",
    description: "Coders, scientists, designers, storytellers, makers, builders, and technologists.",
  },
];
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10">
        <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground mt-2 max-w-2xl mx-auto">
                The NASA International Space Apps Challenge is a hackathon for creatives and technologists around the world to work with NASA's free and open data.
            </p>
        </div>
