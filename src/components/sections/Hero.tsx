    ...
    >
      ...
      <div className="container mx-auto px-4 md:px-6 z-20 relative">
        ...
        <div className="flex justify-center items-center gap-4 mb-6">
          <div
            className="flex justify-center items-center gap-2 text-lg text-primary font-semibold backdrop-blur-sm bg-primary/10 py-2 px-4 rounded-lg border border-primary/20 cursor-pointer hover:bg-primary/15 transition-colors duration-300"
            onClick={() =>
              window.open(
