...
export function RegistrationControl({ settings, onSettingsChange }: RegistrationControlProps) {
    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Manually or schedule when registrations open and close for participants.
                </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4 rounded-md border p-4">
                    <h4 className="font-medium">Schedule Status Change</h4>
